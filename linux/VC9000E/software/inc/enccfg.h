...
#define ENCH2_INPUT_SWAP_64_RGB24 0
#define ENCH2_INPUT_SWAP_32_RGB24 0
#define ENCH2_INPUT_SWAP_16_RGB24 0
#define ENCH2_INPUT_SWAP_8_RGB24 0
...
/* The input image's 64-bit swap: 0 or 1
 * This defines the 64-bit endianess of the ASIC input RGB24
 * 1 = 64-bit endianess */
#ifndef ENCH2_INPUT_SWAP_64_RGB24
#define ENCH2_INPUT_SWAP_64_RGB24 0
#endif

/* The input image's 32-bit swap: 0 or 1
 * This defines the 32-bit endianess of the ASIC input RGB24
 * 1 = 64-bit endianess */
#ifndef ENCH2_INPUT_SWAP_32_RGB24
#define ENCH2_INPUT_SWAP_32_RGB24 0
#endif

/* The input image's 16-bit swap: 0 or 1
 * This defines the 16-bit endianess of the ASIC input RGB24
 */
#ifndef ENCH2_INPUT_SWAP_16_RGB24
#define ENCH2_INPUT_SWAP_16_RGB24 0
#endif

/* The input image's byte swap: 0 or 1
 * This defines the byte endianess of the ASIC input RGB24
 */
#ifndef ENCH2_INPUT_SWAP_8_RGB24
#define ENCH2_INPUT_SWAP_8_RGB24 0
#endif
...
/* Sliceinfo timeout interrupt enable/disable */
#ifndef ENCH2_SLICEINFO_TIMEOUT_INTERRUPT
#define ENCH2_SLICEINFO_TIMEOUT_INTERRUPT 1
#endif
/* Sliceinfo polling timeout cycles */
#ifndef ENCH2_SLICEINFO_POLL_TIMEOUT_CYCLES
#define ENCH2_SLICEINFO_POLL_TIMEOUT_CYCLES 2048
#endif

/* Sliceinfo polling time */
#ifndef ENCH2_SLICEINFO_POLL_TIME
#define ENCH2_SLICEINFO_POLL_TIME 3
#endif

/* Sliceinfo irq type mask for polling timeout
 *    0 = normal interruption
 *    1= abnormal interrupution
 */
#ifndef ENCH2_SLICEINFO_IRQ_TYPE_MASK_POLL_TIMEOUT
#define ENCH2_SLICEINFO_IRQ_TYPE_MASK_POLL_TIMEOUT 0
#endif
