...
typedef struct {
  ...
  lineBufMem decTblLumBuf; /*dec400 table luma address in line buffer */
  lineBufMem decTblCbBuf;  /*dec400 table cb address in line buffer */
  lineBufMem decTblCrBuf;  /*dec400 table cr address in line buffer */
  ...
  u32 client_type; /* */
                   /* asic control */
                   //asicData_s *asic;
  /* src dec400 table related pointers */
  u32 decTileSize;
  u32 alignment;
  u8 *lumDecTblSrc;
  u8 *cbDecTblSrc;
