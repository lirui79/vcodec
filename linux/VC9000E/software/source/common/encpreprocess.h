...
typedef struct {
  ...
  u32 alignLumWidth;					/* Aligned input image width */
  u32 alignLumHeight;					/* Aligned input image height */
  ...
  u32 horOffsetSrc
      [HEVC_MAX_TILE_COLS]; /* Encoded frame offset, reference is ... */
  u32 verOffsetSrc
      [HEVC_MAX_TILE_COLS]; /* ...top  left corner of source image */
  u32 input_alignment;
  u32 inputFormat;
  u32 scanType;
  ...
  u32 overlaySliceYoffset
      [MAX_OVERLAY_NUM];  //Top left offset to place OSD in a slice
