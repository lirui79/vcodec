...
/** \brief The <tt>constraint_set1_flag</tt> field defined in ITU-T Rec. H.264. */
#define SYNTAX_PROFILE_H264_CONSTRAINED (1 << 9)
/** \brief The <tt>constraint_set3_flag</tt> field defined in ITU-T Rec. H.264. */
#define SYNTAX_PROFILE_H264_INTRA (1 << 11)

/** Specifies stream profiles for syntax in the stream.
 *
 * Values prefixed with <tt>SYNTAX__</tt> indicate profiles defined in ITU-T Rec. H.265 and H.264.
 *
 */
typedef enum {
  /** The HEVC Main profile. */
  SYNTAX_PROFILE_HEVC_MAIN = 1,
  /** The HEVC Main 10 profile. */
  SYNTAX_PROFILE_HEVC_MAIN_10 = 2,
  /** The HEVC Main Still Picture profile. */
  SYNTAX_PROFILE_HEVC_MAIN_STILL_PICTURE = 3,
  /** The HEVC format range extensions profile. */
  SYNTAX_PROFILE_HEVC_REXT = 4,
    /** The HEVC high throughput profiles */
  SYNTAX_PROFILE_HEVC_HTHR = 5,
  /** The HEVC screen content coding extensions profile. */
  SYNTAX_PROFILE_HEVC_SCC = 9,

  /** monochrome */
  // SYNTAX_PROFILE_HEVC_MONOCHROME = 4,
  // /** The HEVC Monochrome 10 profile. */
  // SYNTAX_PROFILE_HEVC_MONOCHROME_10 = 5,
  // /** Main 422 10 */
  // SYNTAX_PROFILE_HEVC_MAIN_422_10 = 6,

  /** The H.264 Baseline profile. */
  SYNTAX_PROFILE_H264_BASELINE = 66,
  /** The H.264 Constrained Baseline profile. */
  SYNTAX_PROFILE_H264_CONSTRAINED_BASELINE =
      (66 | SYNTAX_PROFILE_H264_CONSTRAINED),
  ...
  SYNTAX_PROFILE_H264_HIGH_10_INTRA = (110 | SYNTAX_PROFILE_H264_INTRA),
  /** The H.264 Multi-View High profile. */
  SYNTAX_PROFILE_H264_MULTIVIEW_HIGH = 118,
  /** The H.264 High 4:2:2 profile. */
  SYNTAX_PROFILE_H264_HIGH_422 = 122,
  /** The H.264 High 4:2:2 Intra profile. */
  SYNTAX_PROFILE_H264_HIGH_422_INTRA = (122 | SYNTAX_PROFILE_H264_INTRA),
  /** The H.264 Stereo High profile. */
  SYNTAX_PROFILE_H264_STEREO_HIGH = 128,
  /** The H.264 High 4:4:4 Predictive profile. */
  SYNTAX_PROFILE_H264_HIGH_444_PREDICTIVE = 244,
  /** The H.264 High 4:4:4 Intra profile. */
  SYNTAX_PROFILE_H264_HIGH_444_INTRA = (244 | SYNTAX_PROFILE_H264_INTRA),
  /** The H.264 CAVLC 4:4:4 Intra profile. */
...
struct pps {
  ...
  i32 log2_max_transform_skip_block_size_minus_2;
  ...
  i32 pps_extension_present_flag;
  i32 pps_range_extension_flag;
  ...
  true_e
      transform8x8Mode; /*H264 8x8 tranform, 0:1 disable/enable 8x8 transform*/
};
