...
#define VSI_IOCTL_CMD_ALLOC \
  _IOWR(VSIV4L2_IOCTL_BASE, 47, struct vsi_v4l2_mem_info)
#define VSI_IOCTL_CMD_FREE \
  _IOWR(VSIV4L2_IOCTL_BASE, 48, struct vsi_v4l2_mem_info)
